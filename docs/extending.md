...
4. Blank-import the package in `cmd/telemetron/main.go`.
...
After adding the package, import it in `cmd/telemetron/main.go`:

```go
import (
	_ "github.com/inceptionstack/telemetron/internal/claudecode"
)
```
